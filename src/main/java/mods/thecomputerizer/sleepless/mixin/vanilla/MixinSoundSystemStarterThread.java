...
import static mods.thecomputerizer.sleepless.client.render.ClientEffects.QUIET_SOUNDS;
...
public abstract class MixinSoundSystemStarterThread extends SoundSystem {
    ...
    @Override public void setMasterVolume(float volume) {
        if(SleepLessConfigHelper.shouldMuffleSounds()) super.setMasterVolume(volume*QUIET_SOUNDS);
