...
import static mods.thecomputerizer.sleepless.registry.entities.nightterror.phase.PhaseAction.Type.TRANSITION;
...
public class PhaseSpawn extends PhaseBase {
    ...
    @Override protected PhaseAction makeActionQueue() {
        return TRANSITION.create(200)
                .setNextAction(WAIT.create(100).setInvertInvulnerability());
    }
