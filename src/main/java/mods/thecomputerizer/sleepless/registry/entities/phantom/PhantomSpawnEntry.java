...
import static mods.thecomputerizer.sleepless.common.WorldEvents.MAX_PHANTOM_DESPAWN_RANGE;
...
public class PhantomSpawnEntry extends Biome.SpawnListEntry {
    ...
    @Override public @Nonnull EntityLiving newInstance(@Nonnull World world) throws Exception {
        ...
        if(entity instanceof PhantomEntity) {
            ...
            float chance = (this.despawnDistance/MAX_PHANTOM_DESPAWN_RANGE)*2f;
