...
public class NightTerrorMoveHelper extends ExtendedMoveHelper<NightTerrorEntity> {
    ...
    @Override public void onUpdateMoveHelper() {
        ...
        if(this.action==MOVE_TO) {
            ...
            float targetYaw = (float)(MathHelper.atan2(motionZ,motionX)*(180d/PI))-90f;
            ...
            float targetPitch = (float)(-(MathHelper.atan2(motionY,xzHypot)*(180d/PI)));
            this.entity.rotationPitch = this.limitAngle(this.entity.rotationPitch,targetPitch,10f);
