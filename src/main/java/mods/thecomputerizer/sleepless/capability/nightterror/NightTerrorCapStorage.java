...
public class NightTerrorCapStorage implements Capability.IStorage<INightTerrorCap> {
    ...
    @Override public @Nullable NBTBase writeNBT(Capability<INightTerrorCap> capability, INightTerrorCap instance,
            EnumFacing side) {
        return instance.writeToNBT();
    }

    @Override public void readNBT(Capability<INightTerrorCap> capability, INightTerrorCap instance, EnumFacing side,
            NBTBase nbt) {
